...
local Window = OrionLib:MakeWindow({Name = "Bắp Tươi Hub", HidePremium = false, IntroText = "baptuoihub Library", SaveConfig = true, ConfigFolder = "Bắp Tươi Hub"})
----------Tab-----------------------
...
elseif World3 then
	tableBoss = {"Bắp Tươi Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Bắp Tươi Hub(Noitification)",
